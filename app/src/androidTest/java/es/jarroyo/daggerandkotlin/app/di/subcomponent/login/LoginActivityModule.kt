...
class LoginActivityModule(activity: LoginActivity) : ActivityModule(activity) {
    ...
    @Provides
    fun provideLoginPresenter(view: LoginView, navigator: Navigator, loginUseCase: LoginUseCase): LoginPresenter {
        return LoginPresenter(view, navigator, loginUseCase)
        //val loginPresenter: LoginPresenter = mock()
        //return mock(LoginPresenter::class.java)
        //return LoginPresenter(view, navigator, loginUseCase)
    }
